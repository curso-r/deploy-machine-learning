...
- As dependências são numerores e normalmente não são muito comuns (keras, cuda, torch, bibliotecas de algebra linear etc)
...
- Quem não toma cuidado sofre com vazamento de dados!
...
Hoje vamos aprender a construir **sem sofrer** uma API que execute os seguintes passos:
